...
class Button:
    ...
    def __init__(self, x, y, width, height, radius, color, text, textColor, textSize, win):
        ...
        self.timesClicked = 0
        self.shadowColor = color_rgb(10, 30, 20)
    ...
    def draw(self, win):
        ...
        if self.radiusInd:
            ...
            self.shadowCircle4.setOutline(self.shadowColor)
            self.shadowCircle1.setFill(self.shadowColor)
            ...
            self.polyShadow.setOutline(self.shadowColor)
            self.polyShadow.setFill(self.shadowColor)
    ...
    def adjustShadowColor(self, color):
